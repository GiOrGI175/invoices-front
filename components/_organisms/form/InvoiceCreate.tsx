    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className={`fixed lg:max-w-[719px] max-lg:max-w-[616px] w-full lg:h-[100dvh] max-lg:h-[calc(100dvh-80px)]  lg:rounded-[20px] max-lg:rounded-tr-[20px] max-lg:rounded-br-[20px] pb-[170px] max-lg:px-[45px] ${
